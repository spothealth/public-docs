...
| `kit_type_assigned`  | OPTIONAL: In a small number of use cases, kits may change type after being created. This is not used for Spot's standard testing program. |
...
| `collected`            | OPTIONAL: This status occurs when a user clicks "continue" at the bottom of the online instructions after collecting their sample. This status does not always appear as this step is optional and the user does not always complete it.                                    |